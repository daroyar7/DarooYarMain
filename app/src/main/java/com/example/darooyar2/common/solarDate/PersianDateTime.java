...
/**
 * A wrapper class for {@link NewPersianDate} and {@link LocalTime} to encapsulate these classes in one class for the sake
 ...
 */
public final class PersianDateTime implements ChronoLocalDateTime<NewPersianDate> {

    /**
     * The minimum supported Persian date-time {@code 0001-01-01 00:00}.
     */
    private static final PersianDateTime MIN = new PersianDateTime(NewPersianDate.MIN, LocalTime.MIN);

    /**
     * The minimum supported Persian date-time {@code 1999-12-29 23:59:59.999999999}.
     */
    private static final PersianDateTime MAX = new PersianDateTime(NewPersianDate.MAX, LocalTime.MAX);

    /**
     * The Persian date.
     */
    private final NewPersianDate date;
    ...
    public static PersianDateTime now() {
        return new PersianDateTime(NewPersianDate.now(), LocalTime.now());
    }
     ...
     */
    public static PersianDateTime of(final NewPersianDate date, final LocalTime time) {
    ...
    public static PersianDateTime of(final int year, final PersianMonth month, final int dayOfMonth, final int hour,
        ...
        final NewPersianDate date = NewPersianDate.of(year, month, dayOfMonth);
    ...
    public static PersianDateTime fromGregorian(final LocalDateTime localDateTime) {
        ...
        return new PersianDateTime(NewPersianDate.fromGregorian(localDateTime.toLocalDate()), localDateTime.toLocalTime());
    }
    ...
    public static PersianDateTime from(final TemporalAccessor temporal) {
        ...
        if (temporal instanceof PersianDateTime) {
            ...
            try {
                final NewPersianDate date = NewPersianDate.from(temporal);
     ...
     * @param time the time, not {@code null}
     */
    private PersianDateTime(final NewPersianDate date, final LocalTime time) {
     ...
     */
    @Override
    public NewPersianDate toLocalDate() {
        return date;
    }
     ...
     * @see NewPersianDate#getLong(TemporalField)
    ...
    @Override
    public ChronoLocalDateTime<NewPersianDate> with(final TemporalField field, final long newValue) {
        throw new UnsupportedOperationException();
    }

    @Override
    public ChronoLocalDateTime<NewPersianDate> plus(final long amountToAdd, final TemporalUnit temporalUnit) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public ChronoZonedDateTime<NewPersianDate> atZone(final ZoneId zoneId) {
        throw new UnsupportedOperationException();
    }
