...
public final class PersianChronology extends AbstractChronology {
     ...
     */
    @Override
    public NewPersianDate date(int prolepticYear, int month, int dayOfMonth) {
        return NewPersianDate.of(prolepticYear, month, dayOfMonth);
    }
     ...
     */
    @Override
    public NewPersianDate dateYearDay(int prolepticYear, int dayOfYear) {
        checkDayOfYear(prolepticYear, dayOfYear);
        return NewPersianDate.of(prolepticYear, 1, 1).plusDays(dayOfYear - 1);
    }
     ...
     */
    @Override
    public NewPersianDate dateEpochDay(long epochDay) {
        return NewPersianDate.ofEpochDay(epochDay);
    }
     ...
     */
    @Override
    public NewPersianDate date(TemporalAccessor temporal) {
        if (temporal instanceof NewPersianDate) {
            return (NewPersianDate) temporal;
        }
        return NewPersianDate.ofJulianDays(JulianFields.JULIAN_DAY.getFrom(temporal));
    }
    ...
    public boolean isLeapYear(long year) {
        checkValidValue(year, YEAR);
        return NewPersianDate.isLeapYear((int) year);
    }
